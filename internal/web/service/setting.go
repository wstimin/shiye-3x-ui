...
import (
	...
	"github.com/wstimin/shiye-3x-ui/v3/internal/util/netproxy"
	"github.com/wstimin/shiye-3x-ui/v3/internal/util/random"
	"github.com/wstimin/shiye-3x-ui/v3/internal/util/reflect_util"
	"github.com/wstimin/shiye-3x-ui/v3/internal/util/totp"
	"github.com/wstimin/shiye-3x-ui/v3/internal/web/entity"
	"github.com/wstimin/shiye-3x-ui/v3/internal/xray"
	"github.com/wstimin/shiye-3x-ui/v3/internal/xray/dnsconf"
)
...
var defaultValueMap = map[string]string{
	...
	// Customer portal billing + branding. Kept out of AllSetting: the admin
	// settings form never edits them; the portal API reads them directly.
	"portalPricePerDayCents": "0",
	"portalPlans":            "",
	"portalPurchaseUrl":      "",
	"portalSiteTitle":        "Node Service",
