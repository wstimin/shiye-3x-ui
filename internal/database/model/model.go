...
import (
	...
	"github.com/wstimin/shiye-3x-ui/v3/internal/util/json_util"
...
type CouponCode struct {
	Id          int    `json:"id" gorm:"primaryKey;autoIncrement"`
	CodeHash    string `json:"-" gorm:"column:code_hash;uniqueIndex;not null"`
	AmountCents int64  `json:"amountCents" gorm:"column:amount_cents;not null"`
	Status      string `json:"status" gorm:"default:unused;index"`
	BatchNo     string `json:"batchNo" gorm:"column:batch_no;index"`
	Source      string `json:"source" gorm:"default:local"`
	UsedBy      string `json:"usedBy" gorm:"column:used_by;default:''"`
	UsedAt      int64  `json:"usedAt" gorm:"column:used_at;default:0"`
	ExpiresAt   int64  `json:"expiresAt" gorm:"column:expires_at;default:0"`
	CreatedAt   int64  `json:"createdAt" gorm:"autoCreateTime:milli"`
}

func (CouponCode) TableName() string { return "coupon_codes" }

// WalletTxn is an append-only balance ledger: redeem, renew, adjust.
type WalletTxn struct {
	Id           int    `json:"id" gorm:"primaryKey;autoIncrement"`
	Username     string `json:"username" gorm:"index;not null"`
	Kind         string `json:"kind" gorm:"index;not null"`
	AmountCents  int64  `json:"amountCents" gorm:"column:amount_cents;not null"`
	BalanceAfter int64  `json:"balanceAfter" gorm:"column:balance_after;not null"`
	Ref          string `json:"ref" gorm:"default:''"`
	CreatedAt    int64  `json:"createdAt" gorm:"autoCreateTime:milli"`
}

func (WalletTxn) TableName() string { return "wallet_txns" }
