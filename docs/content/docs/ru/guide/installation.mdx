...
[страницы релизов](https://github.com/wstimin/shiye-3x-ui/releases), распаковать его и
...
В каталоге [`deploy/`](https://github.com/wstimin/shiye-3x-ui/tree/main/deploy)
