...
> tree rather than a pinned release (Go module `github.com/wstimin/shiye-3x-ui/v3`).
>
...
- **Module path is `.../v3`.** Internal imports use `github.com/wstimin/shiye-3x-ui/v3/internal/...`.
