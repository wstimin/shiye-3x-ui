...
<p align="center">
  <a href="https://github.com/wstimin/shiye-3x-ui/releases"><img src="https://img.shields.io/github/v/release/wstimin/shiye-3x-ui" alt="Release"></a>
  <a href="https://github.com/wstimin/shiye-3x-ui/actions"><img src="https://img.shields.io/github/actions/workflow/status/wstimin/shiye-3x-ui/release.yml.svg" alt="Build"></a>
  <a href="#"><img src="https://img.shields.io/github/go-mod/go-version/wstimin/shiye-3x-ui.svg" alt="GO Version"></a>
  <a href="https://github.com/wstimin/shiye-3x-ui/releases/latest"><img src="https://img.shields.io/github/downloads/wstimin/shiye-3x-ui/total.svg" alt="Downloads"></a>
  <a href="https://www.gnu.org/licenses/gpl-3.0.en.html"><img src="https://img.shields.io/badge/license-GPL%20V3-blue.svg?longCache=true" alt="License"></a>
  <a href="https://pkg.go.dev/github.com/wstimin/shiye-3x-ui/v3"><img src="https://pkg.go.dev/badge/github.com/wstimin/shiye-3x-ui/v3.svg" alt="Go Reference"></a>
...
```bash
bash <(curl -Ls https://raw.githubusercontent.com/wstimin/shiye-3x-ui/master/install.sh)
```

برای نصب یک نسخه‌ی مشخص، تگ آن را در انتها اضافه کنید (مثلاً `v3.7.0`):

```bash
bash <(curl -Ls https://raw.githubusercontent.com/wstimin/shiye-3x-ui/master/install.sh) v3.7.0
```
...
```bash
bash <(curl -Ls https://raw.githubusercontent.com/wstimin/shiye-3x-ui/master/install.sh) dev-latest
```
...
```bash
docker run -d --cap-add=NET_ADMIN --cap-add=NET_RAW ... ghcr.io/wstimin/shiye-3x-ui
```
...
<a href="https://github.com/wstimin/shiye-3x-ui" target="_blank">
...
<a href="https://www.star-history.com/?repos=wstimin%2Fshiye-3x-ui&type=date&legend=top-left">
 <picture>
   <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/chart?repos=wstimin/shiye-3x-ui&type=date&theme=dark&legend=top-left" />
   <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/chart?repos=wstimin/shiye-3x-ui&type=date&legend=top-left" />
   <img alt="Star History Chart" src="https://api.star-history.com/chart?repos=wstimin/shiye-3x-ui&type=date&legend=top-left" />
 </picture>
</a>

<p align="center">
 <a href="https://www.star-history.com/wstimin/shiye-3x-ui">
  <picture><source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/badge?repo=wstimin/shiye-3x-ui&type=rank&theme=dark" /><source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/badge?repo=wstimin/shiye-3x-ui&type=rank" /><img alt="Star History Rank" src="https://api.star-history.com/badge?repo=wstimin/shiye-3x-ui&type=rank" /></picture> <picture><source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/badge?repo=wstimin/shiye-3x-ui&type=trending&theme=dark" /><source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/badge?repo=wstimin/shiye-3x-ui&type=trending" /><img alt="GitHub Trending Repository of the Day" src="https://api.star-history.com/badge?repo=wstimin/shiye-3x-ui&type=trending" /></picture>
 </a>
</p>
