...
- Backend: Go 1.27, module `github.com/wstimin/shiye-3x-ui/v3`, Gin and GORM.
...
- Linux install: `bash <(curl -Ls https://raw.githubusercontent.com/wstimin/shiye-3x-ui/master/install.sh)`
...
- Docker image `ghcr.io/wstimin/shiye-3x-ui`; PostgreSQL profile
